...
ls
ls operations
ls operations/ops-log
cat operations/ops-log/shift-log.txt
...
```
ls records
ls records/records-2025
cat records/records-2025/maintenance-note.txt
...
```
ls records/records-2024
cat records/records-2024/supply-inventory.txt
...
```
I looked up chmod because I wasn't sure what it did. The manual page told me it changes the mode bits of a file.
...
```
The help text also told me that chmod changes the mode bits of a file.
```
...
```
I was looking for a folder and ended up too deep inside records, which was not where I actually needed to be. I used pwd to check where I was, then cd .. to back up a level and ls to see what was actually around me. That's how I found the operations folder I was originally looking for.
```
...
```
The maintenance note took the longest to find because I was thrown off by folders with similar names (ops-log and ops-notes). I also I also mixed-up operations with records at one point. When I realized the file was inside records-2025 and not the operations folders, I was able to track it down.
```
...
```
At the start of Lesson 3A, looking at the blank shell felt a little scary since I didn't know what to type or what would happen if I got it wrong. During this lab, I still ran into a lot of confusion and errors but I did feel less afraid to just try a command and see what happened and I knew how to check where I was and look things up instead of guessing blindly
```
...
```
I'm looking forward to going deeper in permissions and I'm curious about virtual machines. I would like to understand what makes them different from just running a program on a regular computer.
```
