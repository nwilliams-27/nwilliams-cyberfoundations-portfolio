...
```
The help text told me that grep searches for patterns in each file and will show me the lines that are a match.
```
...
```
Since this is all new to me, everything felt different, from the first command to the last. Navigating folders, moving files, confusion in errors that I made that I had to work through. I realize how much I don't know yet, but I can also figure things out step by step instead of getting stuck.
```
